...
(function(e) {
            ...
            var c = [],
                ...
                f = function(g, n) {
                    ...
                    if (Array.isArray(g) || g instanceof e)
                        ...
                        "object" === typeof g &&
                        g.nodeName &&
                        ((p = e.inArray(g, l)), -1 !== p && c.push({ inst: n, node: l[p] }));
                },
                h = 0,
                m = a.length; h < m; h++
        )
    ...
    e.extend(x, {
        ...
        pageLength: function(a) {
            ...
            return {
                ...
                text: function(h) {
                    return h.i18n(
                        "buttons.pageLength", { "-1": "Mostrar todas las filas", _: "Show %d filas" },
                        h.page.len()
                    );
                },
    ...
    var D = function(a) {
        ...
        L = function(a, b) {
            ...
            h = h.nodes().toArray();
            for (
                var m = b.length, g = [], n = 0, k = 0, p = 0 < m ? f.length / m : 0; k < p; k++
            ) {
