...
(function(h) {
        ...
        if (b)
            for (e = b.length - 1; 0 <= e; e--) {
                ...
                for (g = q.length; f < g; f++)
                    ...
                    q[f], l);
                else if ("string" === typeof q[f]) { j = 0; for (i = m.length; j < i; j++)("_all" == q[f] || h(m[j].nTh).hasClass(q[f])) && d(j, l) }
            }
                ...
                if ("" !== f) {
                    ...
                    for (var i = 0, l = j.length; i < l; i++) {
                        ...
                        if (f) {
                            ...
                            j.splice(0, i + 1);
                            j = j.join(".");
                            if (h.isArray(a)) { i = 0; for (l = a.length; i < l; i++) g.push(c(a[i], b, j)) }
            ...
            var b = function(a, d, e) {
                ...
                for (var g, j, i = 0, l = e.length - 1; i < l; i++) {
                    ...
                    if (g) {
                        ...
                        f.splice(0, i + 1);
                        g = f.join(".");
                        if (h.isArray(d)) { j = 0; for (l = d.length; j < l; j++) f = {}, b(f, d[j], g), a[e[i]].push(f) } else a[e[i]] = d;
                        return
                    }
        ...
        for (i = c.length; f < i; f++) {
            ...
            for (e = d.firstChild; e;) {
                if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                    ...
                    k = 1 === m ? !0 : !1;
                    for (j = 0; j < m; j++)
                        for (g = 0; g < q; g++) a[f + g][l + j] = { cell: e, unique: k }, a[f + g].nTr = d
                }
                e = e.nextSibling
            }
        }
    ...
    function ta(a, b, c) {
        ...
        a.oAjaxData = b;
        t(a, null, "preXhr", [a, b]);
        a.fnServerData ? a.fnServerData.call(j, a.sAjaxSource, h.map(b, function(a, b) { return { name: b, value: a } }), i, a) : a.sAjaxSource || "string" === typeof g ?
    ...
    function wb(a) {
        ...
        for (g = 0; g < c; g++) l = b[g], m = f[g], i = "function" == typeof l.mData ? "function" : l.mData, G.columns.push({ data: i, name: l.sName, searchable: l.bSearchable, orderable: l.bSortable, search: { value: m.sSearch, regex: m.bRegex } }), u("mDataProp_" + g, i), d.bFilter && (u("sSearch_" + g, m.sSearch), u("bRegex_" + g, m.bRegex), u("bSearchable_" + g, l.bSearchable)), d.bSort && u("bSortable_" +
            g, l.bSortable);
    ...
    function ua(a, b) { var c = h.isPlainObject(a.ajax) && a.ajax.dataSrc !== k ? a.ajax.dataSrc : a.sAjaxDataProp; return "data" === c ? b.aaData || b[c] : "" !== c ? S(c)(b) : b }
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            i = h("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT",
                g ? Qa(f, g) : f).on("keypress.DT", function(a) { if (13 == a.keyCode) return !1 }).attr("aria-controls", c);
    ...
    function qb(a) {
        for (var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select/>", { name: c + "_length", "aria-controls": c, "class": b.sLengthSelect }), g = 0, j = f.length; g < j; g++) e[0][g] = new Option("number" === typeof d[g] ? a.fnFormatNumber(d[g]) : d[g], f[g]);
    ...
    function tb(a) {
        ...
        m && i.append(h("<div/>", { "class": f.sScrollFoot }).css({ overflow: "hidden", border: 0, width: d ? !d ? null : w(d) : "100%" }).append(h("<div/>", { "class": f.sScrollFootInner }).append(l.removeAttr("id").css("margin-left", 0).append("bottom" === j ? g : null).append(b.children("tfoot")))));
        var b = i.children(),
            k = b[0],
            f = b[1],
            u = m ? b[2] : null;
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
            ...
            I(function(a, b) { if (h.inArray(a, Yb) !== -1) a.style.width = v[b] }, o);
            h(L).height(0);
    ...
    function Ha(a) {
        ...
        if (d || !u && !f && !e && j == W(a) && j == l.length)
            ...
            for (n = 0; n < i.length; n++) o = c[i[n]], l[n].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig ? w(o.sWidthOrig) : "", o.sWidthOrig && f && h(l[n]).append(h("<div/>").css({ width: o.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
            if (a.aoData.length)
        ...
        m && (b.style.width = w(m));
        if ((m || f) && !a._reszEvt) b = function() { h(E).on("resize.DT-" + a.sInstance, Qa(function() { aa(a) })) },
    ...
    function Ib(a, b) { for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; f < g; f++) c = B(a, f, b, "display") + "", c = c.replace(Zb, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = f); return e }
    ...
    function Y(a) {
        ...
        c = h.isPlainObject(b);
        var l = [];
        f = function(a) { a.length && !h.isArray(a[0]) ? l.push(a) : h.merge(l, a) };
        h.isArray(b) && f(b);
        c && b.pre && f(b.pre);
        f(a.aaSorting);
        c && b.post && f(b.post);
    ...
    function Ya(a, b, c) { var d, e; for (e in b) b.hasOwnProperty(e) && (d = b[e], h.isPlainObject(d) ? (h.isPlainObject(a[e]) || (a[e] = {}), h.extend(!0, a[e], d)) : a[e] = c && "data" !== e && "aaData" !== e && h.isArray(d) ? d.slice() : d); return a }
    ...
    var n = function(a) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" +
                    ...
                    var u = n.settings,
                        j = 0;
                    for (i = u.length; j < i; j++) { var o = u[j]; if (o.nTable == this || o.nTHead && o.nTHead.parentNode == this || o.nTFoot && o.nTFoot.parentNode == this) { var r = g.bRetrieve !== k ? g.bRetrieve : m.bRetrieve; if (c || r) return o.oInstance; if (g.bDestroy !== k ? g.bDestroy : m.bDestroy) { o.oInstance.fnDestroy(); break } else { K(o, 0, "Cannot reinitialise DataTable", 3); return } } if (o.sTableId == this.id) { u.splice(j, 1); break } }
                    if (null ===
    ...
    n.util = {
        ...
        escapeRegex: function(a) { return a.replace(ac, "\\$1") }
    };
    ...
    o("ajax.reload()", function(a, b) { return this.iterator("table", function(c) { Ub(c, !1 === b, a) }) });
    ...
    o("ajax.url().load()", function(a, b) { return this.iterator("table", function(c) { Ub(c, !1 === b, a) }) });
    var bb = function(a, b, c, d, e) {
            ...
            a = v.selector[a];
            if (a.length) { i = 0; for (l = a.length; i < l; i++) f = a[i](d, e, f) }
            return ra(f)
        },
        cb = function(a) {
            a || (a = {});
        ...
        Da = function(a, b) {
            ...
            } else if ("index" == c || "original" == c) { c = 0; for (d = a.aoData.length; c < d; c++) "none" == j ? f.push(c) : (e = h.inArray(c, g), (-1 === e && "removed" == j || 0 <= e && "applied" == j) && f.push(c)) }
            return f
        };
    o("rows()", function(a, b) {
    ...
    o("rows().data()", function() { return this.iterator(!0, "rows", function(a, b) { return ka(a.aoData, b, "_aData") }, 1) });
    ...
    s("rows().remove()", "row().remove()", function() {
        ...
        this.iterator("row", function(b, c, d) {
            ...
            for (h = e.length; g < h; g++)
                if (i = e[g], m = i.anCells, null !== i.nTr && (i.nTr._DT_RowIndex = g), null !== m) { i = 0; for (l = m.length; i < l; i++) m[i]._DT_CellIndex.row = g }
    ...
    o("row.add()", function(a) { a instanceof h && a.length && (a = a[0]); var b = this.iterator("table", function(b) { return a.nodeName && "TR" === a.nodeName.toUpperCase() ? oa(b, a)[0] : O(b, a) }); return this.row(b[0]) });
    ...
    o(["row().child.show()", "row().child().show()"], function() { Vb(this, !0); return this });
    o(["row().child.hide()", "row().child().hide()"], function() { Vb(this, !1); return this });
        ...
        var b = cb(b),
            c = this.iterator("table", function(c) {
                ...
                return bb("column", e, function(a) {
                    ...
                    if (typeof a ===
                        "function") { var e = Da(c, f); return h.map(g, function(b, f) { return a(f, Wb(c, f, 0, 0, e), i[f]) ? f : null }) }
    ...
    s("columns().cache()", "column().cache()", function(a) { return this.iterator("column-rows", function(b, c, d, e, f) { return ka(b.aoData, f, "search" === a ? "_aFilterData" : "_aSortData", c) }, 1) });
    ...
    s("columns().indexes()", "column().index()", function(a) { return this.iterator("column", function(b, c) { return "visible" === a ? ca(b, c) : c }, 1) });
    ...
    o("search()", function(a, b, c, d) { var e = this.context; return a === k ? 0 !== e.length ? e[0].oPreviousSearch.sSearch : k : this.iterator("table", function(e) { e.oFeatures.bFilter && ha(e, h.extend({}, e.oPreviousSearch, { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), 1) }) });
    ...
    h.each(["column", "row", "cell"], function(a, b) {
        o(b + "s().every()", function(a) {
            var d = this.selector.opts,
                e =
                this;
            return this.iterator(b, function(f, g, h, i, l) { a.call(e[b](g, "cell" === b ? h : d, "cell" === b ? d : k), g, h, i, l) })
        })
    });
    ...
    h.extend(n.ext.type.detect, [function(a, b) { var c = b.oLanguage.sDecimal; return ab(a, c) ? "num" + c : null }, function(a) { if (a && !(a instanceof Date) && !$b.test(a)) return null; var b = Date.parse(a); return null !== b && !isNaN(b) || M(a) ? "date" : null }, function(a, b) {
        ...
        return ab(a,
            c, !0) ? "num-fmt" + c : null
    }, function(a, b) { var c = b.oLanguage.sDecimal; return Rb(a, c) ? "html-num" + c : null }, function(a, b) { var c = b.oLanguage.sDecimal; return Rb(a, c, !0) ? "html-num-fmt" + c : null }, function(a) { return M(a) || "string" === typeof a && -1 !== a.indexOf("<") ? "html" : null }]);
    h.extend(n.ext.type.search, { html: function(a) { return M(a) ? a : "string" === typeof a ? a.replace(Ob, " ").replace(Ca, "") : "" }, string: function(a) { return M(a) ? a : "string" === typeof a ? a.replace(Ob, " ") : a } });
    ...
    var fb = function(a) { return "string" === typeof a ? a.replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;") : a };
    n.render = {
