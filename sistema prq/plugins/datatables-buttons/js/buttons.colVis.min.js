(function(g) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(d) { return g(d, window, document) }) : "object" === typeof exports ? module.exports = function(d, f) {
        d || (d = window);
    ...
    g.extend(d.ext.buttons, {
        ...
        columnVisibility: {
            ...
            init: function(a, b, c) {
                ...
                a.on("column-visibility.dt" + c.namespace, function(b, d) {!d.bDestroying && d.nTable == a.settings()[0].nTable && e.active(a.column(c.columns).visible()) }).on("column-reorder.dt" +
                    c.namespace,
                    function() { 1 === a.columns(c.columns).count() && (b.text(c._columnText(a, c)), e.active(a.column(c.columns).visible())) });
        ...
        colvisRestore: {
            ...
            text: function(a) { return a.i18n("buttons.colvisRestore", "Restore visibility") },
