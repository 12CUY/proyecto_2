(function(j) {
        ...
        j.each(b, function(b, c) {
            if (j.isPlainObject(c)) {
                ...
                if (s) {
                    ...
                    g = 0;
                    for (w = i.length; g < w; g++) f = c.createAttribute(i[g].name.replace(":", "_dt_b_namespace_token_")),
    ...
    function n(a, b, d) {
        ...
        d && (d.attr && j(c).attr(d.attr), d.children && j.each(d.children, function(a, b) { c.appendChild(b) }), null !== d.text && d.text !== o && c.appendChild(a.createTextNode(d.text)));
        return c
    }
    ...
    if ("undefined" === typeof h || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) u = void 0;
        ...
        var y = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
            ...
            F = function(a, b, d) {
                ...
                c.readyState = c.INIT;
                if (M) e =
                    (h.URL || h.webkitURL || h).createObjectURL(a), setTimeout(function() {
                        y.href = e;
                        y.download = b;
                    ...
                    j.readAsDataURL(a);
                    c.readyState = c.INIT
                } else e || (e = (h.URL || h.webkitURL || h).createObjectURL(a)), d ? h.location.href = e : h.open(e,
    ...
    q.ext.buttons.copyHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            h = j("<span>" + b.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") +
                "</span>").append(d);
            ...
            j(k).on("keydown.buttons-copy", function(a) { 27 === a.keyCode && (o(), e.processing(!1)) }).on("copy.buttons-copy cut.buttons-copy", function() {
                o();
                e.processing(!1)
            })
        },
    ...
    q.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            var e = this,
                ...
                q, r, m = function(a) {
                    ...
                    for (var b = 0, d = a.length; b < d; b++) {
                        ...
                        f || ("number" === typeof a[b] || a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/) ? f = n(i, "c", { attr: { t: "n", r: e }, children: [n(i, "v", { text: a[b] })] }) : (h = !h.replace ? h : h.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""), f = n(i, "c", {
            ...
            p = 0;
            for (s = k.header.length; p < s; p++) m.appendChild(n(i, "col", { attr: { min: p + 1, max: p + 1, width: L(k, p), customWidth: 1 } }));
            m = a.xl["workbook.xml"];
            ...
            })), j("definedNames", m).append(n(m, "definedName", { attr: { name: "_xlnm._FilterDatabase", localSheetId: "0", hidden: 1 }, text: G(c) + "!$A$" + d + ":" + x(k.header.length - 1) + h })));
    ...
    q.ext.buttons.pdfHtml5 = {
        ...
        available: function() { return f.FileReader !== o && (r || f.pdfMake) },
        ...
        action: function(a, b, d, c) {
            ...
            var d = b.buttons.exportData(c.exportOptions),
                ...
                e = [];
            c.header && e.push(j.map(d.header,
                function(a) { return { text: "string" === typeof a ? a : a + "", style: "tableHeader" } }));
            ...
            c.footer && d.footer && e.push(j.map(d.footer, function(a) { return { text: "string" === typeof a ? a : a + "", style: "tableFooter" } }));
            d = {
                pageSize: c.pageSize,
