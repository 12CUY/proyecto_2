...
!(function(n) {
    ...
    function o(s) {
        s.element.find("option").each(function(e, t) {
            var n = a(t);
            void 0 === n.data("original-index") &&
                n.data("original-index", s.elementCount++),
                void 0 === n.data("_selected") && n.data("_selected", !1);
        });
    }
    ...
    function r(s, i, l) {
        s.element.find("option").each(function(e, t) {
            var n = a(t);
            n.data("original-index") === i &&
                (n.prop("selected", l),
                    l ?
                    (n.attr("data-sortindex", s.sortIndex), s.sortIndex++) :
    ...
    function h(e) {
        if (e.settings.infoText) {
            ...
            (l =
                ...
                c(t === s ? e.settings.infoText : e.settings.infoTextFiltered, [
                    t,
                    s,
                ])),
            e.elements.info1.html(l),
                e.elements.box1.toggleClass("filtered", !(t === s || 0 === s)),
                (l =
                    0 === i ?
                    e.settings.infoTextEmpty :
                    c(n === i ? e.settings.infoText : e.settings.infoTextFiltered, [
                        n,
                        i,
                    ])),
                e.elements.info2.html(l),
                e.elements.box2.toggleClass("filtered", !(n === i || 0 === i));
        }
    }

    function m(s) {
        (s.selectedElements = 0),
        s.elements.select1.empty(),
            s.elements.select2.empty(),
            s.element.find("option").each(function(e, t) {
                var n = a(t);
                n.prop("selected") ?
                    (s.selectedElements++,
                        s.elements.select2.append(
                            n.clone(!0).prop("selected", n.data("_selected"))
                        )) :
                    s.elements.select1.append(
                        n.clone(!0).prop("selected", n.data("_selected"))
                    );
            }),
            s.settings.showFilterInputs && (e(s, 1), e(s, 2)),
            h(s);
    }
        ...
        if (i.settings.showFilterInputs) {
            ...
            e.each(function(e, t) {
                    var n = a(t),
                        s = !0;
                    (t.text.match(o) ||
                        (i.settings.filterOnValues && n.attr("value").match(o))) &&
                    ((s = !1),
                        i.elements["select" + l].append(
                            n.clone(!0).prop("selected", n.data("_selected"))
                        )),
                    r.eq(n.data("original-index")).data("filtered" + l, s);
                }),
                h(i);
        }
    }
    ...
    function v(e) {
        e.find("option")
            .sort(function(e, t) {
                return a(e).data("original-index") > a(t).data("original-index") ?
                    1 :
                    -1;
            })
            .appendTo(e);
    ...
    function f(s) {
        "all" !== s.settings.preserveSelectionOnMove || s.settings.moveOnSelect ?
            "moved" !== s.settings.preserveSelectionOnMove ||
            s.settings.moveOnSelect ||
            d(s, 1) :
            (d(s, 1), d(s, 2)),
            s.elements.select1.find("option:selected").each(function(e, t) {
                var n = a(t);
                n.data("filtered1") || r(s, n.data("original-index"), !0);
            }),
            m(s),
            t(s),
            s.settings.sortByInputOrder ?
            u(s.elements.select2) :
            v(s.elements.select2);
    }
    ...
    function p(s) {
        "all" !== s.settings.preserveSelectionOnMove || s.settings.moveOnSelect ?
            ...
            d(s, 2) :
            (d(s, 1), d(s, 2)),
            s.elements.select2.find("option:selected").each(function(e, t) {
                var n = a(t);
                n.data("filtered2") || r(s, n.data("original-index"), !1);
            }),
            m(s),
            t(s),
            v(s.elements.select1),
            s.settings.sortByInputOrder && u(s.elements.select2);
    }

    function g(n) {
        n.elements.form.submit(function(e) {
                n.elements.filterInput1.is(":focus") ?
                    (e.preventDefault(), n.elements.filterInput1.focusout()) :
                    n.elements.filterInput2.is(":focus") &&
                    (e.preventDefault(), n.elements.filterInput2.focusout());
            }),
            ...
            }), !1 === n.settings.eventMoveOverride &&
            n.elements.moveButton.on("click", function() {
                f(n);
            }), !1 === n.settings.eventMoveAllOverride &&
            n.elements.moveAllButton.on("click", function() {
                var s;
                "all" !== (s = n).settings.preserveSelectionOnMove ||
                    s.settings.moveOnSelect ?
                    "moved" !== s.settings.preserveSelectionOnMove ||
                    s.settings.moveOnSelect ||
                    d(s, 1) :
                    ...
                    s.element.find("option").each(function(e, t) {
                        ...
                        n.data("filtered1") ||
                            (n.prop("selected", !0),
                                n.attr("data-sortindex", s.sortIndex),
                                s.sortIndex++);
                    }),
                    m(s),
                    t(s);
            }), !1 === n.settings.eventRemoveOverride &&
            n.elements.removeButton.on("click", function() {
                p(n);
            }), !1 === n.settings.eventRemoveAllOverride &&
            n.elements.removeAllButton.on("click", function() {
                var e;
                "all" !== (e = n).settings.preserveSelectionOnMove ||
                    e.settings.moveOnSelect ?
                    "moved" !== e.settings.preserveSelectionOnMove ||
                    e.settings.moveOnSelect ||
                    d(e, 2) :
                    (d(e, 1), d(e, 2)),
                    e.element.find("option").each(function(e, t) {
                        var n = a(t);
                        n.data("filtered2") ||
                            (n.prop("selected", !1), n.removeAttr("data-sortindex"));
                    }),
                    m(e),
                    t(e);
            }),
    ...
    (l.prototype = {
        init: function() {
            ...
            return (
                this.elements.select1.attr("id", e),
                this.elements.select2.attr("id", t),
                this.elements.label1.attr("for", e),
                this.elements.label2.attr("for", t),
        ...
        setMoveOnSelect: function(e, t) {
            if (
                ...
                this.elements.removeButton.insertBefore(
                    this.elements.removeAllButton
                );
        ...
        setMoveOnDoubleClick: function(e, t) {
            if (
                (s && (e = !1),
                    (this.settings.moveOnDoubleClick = e),
                    this.settings.moveOnDoubleClick)
            ) {
        ...
        setInfoText: function(e, t) {
            return (
                (this.settings.infoText = e) ?
                (this.elements.info1.show(), this.elements.info2.show()) :
                (this.elements.info1.hide(), this.elements.info2.hide()),
                t && m(this),
                this.element
            );
        },
        ...
        setEventMoveAllOverride: function(e, t) {
            return (
                (this.settings.eventMoveAllOverride = e), t && m(this), this.element
            );
        },
        setEventRemoveOverride: function(e, t) {
            return (
                (this.settings.eventRemoveOverride = e), t && m(this), this.element
            );
        },
        setEventRemoveAllOverride: function(e, t) {
            return (
                (this.settings.eventRemoveAllOverride = e), t && m(this), this.element
            );
        },
        setBtnClass: function(e, t) {
            return (
                (this.settings.btnClass = e),
                this.elements.moveButton.attr("class", "btn move").addClass(e),
                this.elements.removeButton.attr("class", "btn remove").addClass(e),
                this.elements.moveAllButton.attr("class", "btn moveall").addClass(e),
                this.elements.removeAllButton
                .attr("class", "btn removeall")
                .addClass(e),
                t && m(this),
                this.element
            );
        ...
        setBtnMoveText: function(e, t) {
            return (
                (this.settings.btnMoveText = e),
                this.elements.moveButton.html(e),
                t && m(this),
                this.element
            );
        },
        setBtnRemoveText: function(e, t) {
            return (
                (this.settings.btnMoveText = e),
                this.elements.removeButton.html(e),
                t && m(this),
                this.element
            );
        },
        setBtnMoveAllText: function(e, t) {
            return (
                (this.settings.btnMoveText = e),
                this.elements.moveAllButton.html(e),
                t && m(this),
                this.element
            );
        },
        setBtnRemoveAllText: function(e, t) {
            return (
                (this.settings.btnMoveText = e),
                this.elements.removeAllButton.html(e),
                t && m(this),
                this.element
            );
        },
    ...
    (a.fn[i] = function(n) {
        ...
        return void 0 === n || "object" == typeof n ?
            this.each(function() {
                a(this).is("select") ?
                    a.data(this, "plugin_" + i) ||
                    a.data(this, "plugin_" + i, new l(this, n)) :
                    a(this)
                    .find("select")
                    .each(function(e, t) {
            ...
            (this.each(function() {
                    ...
                    e instanceof l &&
                        "function" == typeof e[n] &&
                        (t = e[n].apply(e, Array.prototype.slice.call(s, 1)));
                }),
                void 0 !== t ? t : this) :
            void 0;
    });
