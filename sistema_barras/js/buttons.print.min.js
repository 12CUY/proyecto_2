    ...
    u.ext.buttons.print = {
        ...
        action: function(a, e, p, k) {
            ...
            if (c) {
                ...
                e.buttons.info(
                    e.i18n("buttons.printErrorTitle", "No se puede abrir la vista de impresión"),
                    e.i18n(
                        "buttons.printErrorMsg",
                        "Permita las ventanas emergentes en su navegador para que este sitio pueda ver la vista de impresión."
                    ),
                    5e3
                );
        },
