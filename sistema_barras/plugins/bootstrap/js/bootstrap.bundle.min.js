...
!(function(e, t) {
                    ...
                    this._element.hasAttribute("disabled") ||
                        ...
                        (t &&
                            this._element.setAttribute(
                                "aria-pressed", !this._element.classList.contains(T)
                            ),
    ...
    p(document)
        .on(P.CLICK_DATA_API, D, function(e) {
            var t = e.target;
            if (
                (p(t).hasClass(C) || (t = p(t).closest(L)[0]), !t || t.hasAttribute("disabled") || t.classList.contains("disabled"))
            )
                e.preventDefault();
            else {
        ...
        p(window).on(P.LOAD_DATA_API, function() {
            ...
            for (
                var r = 0, s = (e = [].slice.call(document.querySelectorAll(A))).length; r < s; r++
            ) {
                var a = e[r];
    ...
    function Fe(e) {
        ...
        for (
            var t = Re(10) ? document.body : null, n = e.offsetParent || null; n === t && e.nextElementSibling;
                ...
                (c._dataApiKeydownHandler = function(e) {
                    if (
                        (/input|textarea/i.test(e.target.tagName) ?
                            ...
                            Lt.test(e.which)) &&
                        (e.preventDefault(),
                            e.stopPropagation(), !this.disabled && !p(this).hasClass(xt))
                    ) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ((this._backdrop = document.createElement("div")),
                                ...
                                p(this._backdrop).addClass(pn), !e)
                        )
                            return;
                        if (!n) return void e();
    ...
    p(window).on(gi.LOAD_DATA_API, function() {
            for (
                var e = [].slice.call(document.querySelectorAll(yi)), t = e.length; t--;
